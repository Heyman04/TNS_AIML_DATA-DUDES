...
ASSET_DIR = Path(__file__).resolve().parent.parent / "assets" / "personas"
PERSONA_ART = {
...
def result():
    ...
    st.write('')
    for col,(label,value) in zip(st.columns(3),[('Customer Group',persona),('Annual Income',f'${income:,.1f}K'),('Spending Score',f'{int(score)}/100')]):
